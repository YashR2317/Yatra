...
import tourData from "../../data/virtual-tours/sikandra.json";
...
export default function Sikandra() {
  ...
  const goBack = () => {
    ...
    if (tour !== "sikandra") navigate(`/virtual-tours/${tour}`);
    ...
    <div className="w-screen h-screen flex flex-col overflow-hidden bg-[var(--color-midnight)]">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          >
            Virtual Tour — <span className="text-gradient-gold">Tomb of Akbar the Great</span>
          </h1>
        </div>
        <div className="hidden md:flex items-center gap-2">
          <span className="text-white/40 text-xs font-body uppercase tracking-widest">Spot</span>
          <span className="text-white/80 text-sm font-semibold font-body bg-white/[0.08] px-2.5 py-0.5 rounded-lg">
            {spot.heading || spotId}
          </span>
        </div>
      </div>
