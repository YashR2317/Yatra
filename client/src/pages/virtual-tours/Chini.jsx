...
import tourData from "../../data/virtual-tours/chini.json";
...
export default function Chini() {
  ...
  const goBack = () => {
    ...
    if (tour !== "chini") navigate(`/virtual-tours/${tour}`);
    ...
    <div className="w-screen h-screen flex flex-col overflow-hidden bg-[var(--color-midnight)]">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          >
            Virtual Tour — <span className="text-gradient-gold">Chini Ka Rauza</span>
          </h1>
        </div>
