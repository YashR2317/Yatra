...
import tourData from "../../data/virtual-tours/itmad.json";
...
export default function Itmad() {
  ...
  const goBack = () => {
    ...
    if (tour !== "itmad") navigate(`/virtual-tours/${tour}`);
    ...
    <div className="w-screen h-screen flex flex-col overflow-hidden bg-[var(--color-midnight)]">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          >
            Virtual Tour — <span className="text-gradient-gold">Tomb of Itmad-ud-Daulah</span>
          </h1>
        </div>
