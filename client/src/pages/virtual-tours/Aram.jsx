...
import tourData from "../../data/virtual-tours/aram.json";
...
export default function Aram() {
  ...
  const goBack = () => {
    ...
    if (tour !== "aram") navigate(`/virtual-tours/${tour}`);
    ...
    <div className="w-screen h-screen flex flex-col overflow-hidden bg-[var(--color-midnight)]">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          >
            Virtual Tour — <span className="text-gradient-gold">Aram Bagh</span>
          </h1>
        </div>
