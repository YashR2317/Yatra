...
/**
 * GoogleSignInButton — renders the "Sign in with Google" button
 * using Google Identity Services.
 *
 * Props:
 *   onSuccess(data) — called with { token, user } on success
 *   onError(message) — called with error string on failure
    ...
    if (!GOOGLE_CLIENT_ID || GOOGLE_CLIENT_ID === "YOUR_GOOGLE_CLIENT_ID_HERE") {
        return (
            <button
                ...
                title="Google OAuth not configured — set VITE_GOOGLE_CLIENT_ID in .env"
            >
